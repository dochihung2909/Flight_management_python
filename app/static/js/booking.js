function search_flight() {
    end_date = end.value && roundTrip.checked || undefined
    ...
    fetch('/api/flight', {
        ...
        if (data.status == 200) {
            flights.foreach(function (f,i) {
                document.getElementById('flight_container').innerHTML = `
                    <div class="max-w-full  bg-white flex flex-col rounded overflow-hidden shadow-lg">
                        ...
                        <div class="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap ">
                            ...
                            <div class="flex flex-col p-2">
                                <p class="font-bold">${f.departure_time.getTime()}</p>
                                <p class="text-gray-500"><span class="font-bold">HRE</span> ${f.route}</p>
