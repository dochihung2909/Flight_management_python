...
app.add_url_rule('/em/schedule/<flight_id>', 'update_schedule', controller.update_schedule, methods=['POST', 'GET'])
...
app.add_url_rule('/api/flight/<flight_id>', 'update_flight', controller.update_flight, methods=['POST', 'GET'])
